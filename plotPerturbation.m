% plot : perturbed quadratic objection function
%
% data description:
...
%% data
dat = load('perturbationGauDat.mat'); % Gaussian noise
eta = dat.eta;
gamma = dat.gamma;
recordIterationNumberGau = dat.recordIterationNumber;
 
%dat = load('perturbationUniDat.mat'); % Uniform noise
%recordIterationNumberUni = dat.recordIterationNumber;

%dat = load('perturbationBerDat.mat'); % Bernoulli noise
%recordIterationNumberBer = dat.recordIterationNumber;

%dat = load('perturbationSphDat.mat'); % Spherical Gaussian noise
...
saveas(gcf,['./','perturbationGauFig','.pdf']);
...
saveas(gcf,['./','perturbationUniFig','.pdf']);
...
saveas(gcf,['./','perturbationBerFig','.pdf']);
...
saveas(gcf,['./','perturbationSphFig','.pdf']);
